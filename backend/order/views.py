...
def mercadopago_start_order(request):
	...
	if request.method == 'POST':
		...
		order = Order(user=user, first_name=first_name, last_name=last_name, email=email, address=address, zipcode=zipcode, place=place, phone=phone, paid=paid, paid_amount=paid_amount)
		order.save()
